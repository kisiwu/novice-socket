...
NspBuilder.prototype.add = function () {
  ...
  if(args.some(arg => !isListenerBuilder(arg))){
    ...
    if (!args.some(arg => typeof arg !== 'function')) {
      return this.addMiddlewares.call(this, args);
    }
 ...
 */
NspBuilder.prototype.addMiddlewares = function (fn) {
...
NspBuilder.prototype.registerMiddlewares = function (namespace, nsp, io) {
