...
describe('Usage', () => {
  ...
  it('should create namespace \'/main\' and add events', () => {
    ...
    nsp.add(new ListenerBuilder({
      ...
      // const _sock: CustomSocket = this.req.socket
  ...
  it('should create app limited to namespace \'/main\'', () => {
  ...
  it('should link namespace \'/main\' into app (\'add\' method)', () => {
  ...
  it('should build app (clients can connect)', () => {
  ...
  it('should destroy app (disconnects all clients)', () => {
    serverApp.destroy();
  ...
  it('should build and destroy app again', () => {
    serverApp.build();
